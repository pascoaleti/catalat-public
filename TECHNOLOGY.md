...
The Catalat Android app is a **native Android application**.

- Primary language: **Java 17**
- Platform: **Android SDK**
- Build system: **Gradle with Groovy DSL**
- Android libraries: **AndroidX**
- Minimum Android API: **21**
- Target Android API: **36 (Android 16)**

The app uses native Android components and communicates with the Catalat platform through its controlled application API.
